...
# 1 "APP/../projectsdefines.h" 1
# 15 "APP/../projectsdefines.h"
...
# 1 "APP/../BIOS/bios.h" 1
# 11 "APP/../BIOS/bios.h"
# 1 "APP/../BIOS/pinmap.h" 1
# 17 "APP/../BIOS/pinmap.h"
    void initPinmap(void);
# 11 "APP/../BIOS/bios.h" 2
...
unsigned char set_passcode[4] = "0000";
unsigned char pass_set_msg[] = "1.SetPass";
unsigned char unlock_msg[] = "2.unlock  ";
unsigned char lock_msg[] = "3.lock";
char old_password[4] = {};
unsigned char renter_old_password_msg[] = "Enter old Pass";
unsigned char enter_newPass_msg[] = "Enter new Pass";
...
# 6 "APP/app.c" 2
    ...
    void runApp()
    {
     ...
     delay2(5);
         ...
         for(i=0;i<1;i++)
           {
             ...
             while(PORTBbits.RB4==1 && PORTBbits.RB5==1 && PORTBbits.RB6==1 && PORTBbits.RB7==1);
             if(PORTBbits.RB4==0)
             {
                 col1();
             }
        ...
        switch(ch)
        {
            ...
            case '2':
                lcd_reset();
                set_passcode[0] = read_from_eeprom(address);
                set_passcode[1] = read_from_eeprom(address+1);
                set_passcode[2] = read_from_eeprom(address+2);
                set_passcode[3] = read_from_eeprom(address+3);
                sprintf(old_password,"%c%c%c%c",set_passcode[0],set_passcode[1],set_passcode[2],set_passcode[3]);
                c = '1';
                unlock_door();
    ...
    char* user_validation()
    {
      ...
      char *p,*q;
      p=strstr((char*)type_passcode,(char*)old_password);
    ...
    void set_password()
    {
         for(i=0;enter_newPass_msg[i]!='\0';i++)
         {
              lcd_data(enter_newPass_msg[i]);
         }
         lcd_cmd(0xc0);
       for(i=0;i<4;i++)
         {
       ...
       write_to_eeprom(address, set_passcode[0]);
       write_to_eeprom(address+1, set_passcode[1]);
       write_to_eeprom(address+2, set_passcode[2]);
       write_to_eeprom(address+3, set_passcode[3]);
    }
    void compare(char c)
    {
      char *p,*q;
