...
# 6 "APP/app.c" 2
    ...
    void runApp()
    {
     ...
     delay2(5);
       ...
       write_to_eeprom(address, admin_passcode[0]);
       write_to_eeprom(address+1, admin_passcode[1]);
       write_to_eeprom(address+2, admin_passcode[2]);
       write_to_eeprom(address+3, admin_passcode[3]);
        ...
        switch(ch)
        {
            case '1':
                ...
                sprintf(admin_password,"%c%c%c%c",admin_passcode[0],admin_passcode[1],admin_passcode[2],admin_passcode[3]);
                     if(admin_validation(admin_password)!=((void*)0))
                     {
                        lcd_reset();
